...
- **[go-c-log](https://www.google.com/search?q=https://github.com/w1ntap3/go-c-log)** – Asynchronous, encrypted UDP logging engine written in C (ESP-IDF/LwIP) paired with a concurrent Go collector. Developed with a friend to demonstrate lock-free FreeRTOS buffers, hardware AES-128-GCM, custom binary framing, and network state recovery.
